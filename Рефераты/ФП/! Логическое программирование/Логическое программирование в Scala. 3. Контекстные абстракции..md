...
Если вызываемая функция ожидает неявное значение, то его можно передать и явно, с помощью ключевого слова `using`. В этом случае значение будет размещено только в *контекст вызова* этой функции:
```scala
...
- Logic programming in scala ([part 1](https://like-a-boss.net/2020/07/07/logic-programming-in-scala.html), [part 2](https://like-a-boss.net/2020/07/10/logic-programming-in-scala-part-2.html)) — обзор в двух частях Бартоша Витковски
- Из блога Юджина Йокоты о контекстных  абстракциях в Scala:
