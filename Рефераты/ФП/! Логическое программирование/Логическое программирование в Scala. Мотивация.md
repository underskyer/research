...
given contentParser: ContentParser =  
  case (content, limit) => IO: // сделаем асинхронной для больших файлов и лимитов
    "\\d+".r  
...
Порой бывает сложно даже *обнаружить сбои*, порождённые ошибками.
