...
```
Для примера нам достаточно только типобезопасности, поэтому обойдёмся простыми `case class` вместо более строгих решений вроде [непрозрачных псевдонимов](https://docs.scala-lang.org/scala3/book/types-opaque-types.html) или [уточнённых типов](https://iltotore.github.io/iron/docs/overview.html).
