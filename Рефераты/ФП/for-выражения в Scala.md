...
> В твоем примере куча операторов дополнительных
...
Другие операции строятся как частные случаи (`productM` и т.п.) и комбинации вышеперечисленных (`flatMap`, `filter`…).
