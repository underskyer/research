...
# Примеры зависимых типов в Scala
...
$$
\begin{split}
Node[A, T_1, T_2] := A \times T_1 \times T_2,
\\
Node[A, T_1, Node[A, T_2, T_3]] = A \times T_1 \times (A \times T_2 \times T_3),
\\
Node[A, Node[A, T_1, T_2], T_3] = A \times (A \times T_1 \times T_2) \times T_3,
\\
Node[A, T_1, Node[A, T_2, T_3]] \sim Node[A, Node[A, T_1, T_2], T_3],
\end{split}
$$
$$
\begin{split}
Cnt[A] = 1 + SA,
\\
Addable[A_1, A_2] = A_1 \times A_2,
\\
Num[A] = Addable[Cnt[A]] = (1 + SA) \times (1 + SA) = 1 + 2SA + SA \times SA,
\\
Addable[SA_1, A_2] \rightarrow Addable[A_1, SA_2]
\end{split}
$$
...
[Dependent type theory and 'arbitrary' type functions](https://stackoverflow.com/questions/9190352/abusing-the-algebra-of-algebraic-data-types-why-does-this-work/42041925#42041925) (ответ на StackOverflow)

[GENERIC PROGRAMMING WITHIN DEPENDENTLY TYPED PROGRAMMING](https://people.cs.nott.ac.uk/psztxa/publ/wcgp02.pdf)
...
[Очень зависимые типы](https://akuklev.livejournal.com/1194050.html) обобщение, возможно не нужное
...
узнать про конструктивность типов сумм и произведений! (алгоритм пробегания по типам и значениям)
...
> Любой предел можно построить из **произведений** и **уравнителей**.
...
Ф. В. Ловир, F. W. Lawvere

[Lawvere Theories](https://stringdiagram.com/2022/11/28/lawvere-theories/) (stringdiagram)
