...
С другой стороны, единица сопряжения «стягивает» два объекта $a,\,b: \mathcal{D}$ в один $RLd=RLd': \mathcal{D}$. Из образа функтора $R$ не получится перейти к исходным объектам, но в некотором смысле  также делает всё возможное, чтобы восполнить потери $L$, но несколько иначе. Объект  будет «наиболее общим» в том смысле, что мы всегда сможем *получить его* из исходных объектов $d,\, d':\: \mathcal{D}$. Тут нам помогает единица сопряжения $\eta:\; Id \rightsquigarrow R \circ L$.
...
Название странноватенькое… У математиков вообще очень своеобразное воображение. Но давайте всё же попробуем их понять ~~и простить~~. Как же можно «расширить» функтор «вдоль другого»?

### !! что расширяем-то?

![[Pasted image 20251214230949.png]]
