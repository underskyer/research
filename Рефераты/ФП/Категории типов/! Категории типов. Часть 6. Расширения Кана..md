...
Из двух естественных преобразований осталось только одно, и на роль подходящего $K/F$ будут претендовать разные неизоморфные функторы. Как обычно, лучшего из них мы выбираем с помощью *универсального свойства*.
