...
Пусть у нас есть функтор $F$, и нам нужно найти для него такой $G$, для которого имелись бы естественные преобразования
$$
\begin{eqnarray}
F \circ G \rightsquigarrow Id\\
Id \rightsquigarrow G \circ F\\
\end{eqnarray}
$$
