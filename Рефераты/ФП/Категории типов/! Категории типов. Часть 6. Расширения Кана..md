...
Подъёмы Кана обладают свойствами, аналогичными расширениям, и они имеют такое же право называться «делением функторов». Так что в сумме мы имеем целых четыре различные операции, обратные композиции функторов. И это одна из причин, почему инфиксный оператор $/$ не считается стандартным обозначением для правого расширения Кана.
...
$$
\begin{eqnarray}
\mathrm{Lan}_F{Id} \dashv F \dashv \mathrm{Ran}_F{Id}\\
