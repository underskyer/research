...
Запись правого расширения Кана через инфиксный оператор $F/G$ отражает своего рода «обратность» этой конструкции по отношению к композиции функторов, аналогично делению по отношению к умножению. Однако, более привычным является обозначение $\mathrm{Ran}_GF$ — 
