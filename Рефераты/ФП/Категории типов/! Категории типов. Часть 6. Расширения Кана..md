...
![[! Диаграммы для 6 части#Восстановление моноида]]
Для любого множества $x$ функтор $F$ подбирает такой моноид $Fx$, чтобы каждому морфизму моноидов $Fx \rightarrow m$ взаимно однозначно соответствовал морфизм множеств $x \rightarrow Um$. Очевидно, что $UFx \neq x$, то есть функтор $F$ приводит к моноиду, у которого *основное множество* будет отличаться от исходного. Объект $Fx$ представляет собой *наиболее общий моноид* для множества $x$, такой, что для него существует столько же способов получить произвольный моноид $m$, сколько и обычных функций от $x$ к множеству $m$.
