...
![[Вспомнить всё.png|Примерно так сопряжение помогает востановить всё то, что функторы растеряли по дороге.|600]]
...
\begin{eqnarray}
&
K:\; \mathcal{C} \rightarrow \mathcal{D},\,
F:\; \mathcal{C} \rightarrow \mathcal{A}
\\ \\
& K/F: \mathcal{A} \rightarrow \mathcal{D}\\
&\varepsilon:\; K/F \circ F \rightsquigarrow K
\end{eqnarray}
$$
### !!! обтекание 
![[! Диаграммы для 6 части#Расширение Кана]]

Из двух естественных преобразований осталось только одно, и на роль подходящего $K/F$ будут претендовать разные неизоморфные функторы. Как обычно, лучшего из них мы выбираем с помощью *универсального свойства*: для любого кандидата $G:\mathcal{A} \rightarrow \mathcal{D}$ с преобразованием $\alpha: G \circ F \rightsquigarrow K$ существует единственное преобразование $u: G \rightsquigarrow K/F$, такое что $\alpha=\varepsilon \cdot (u \circ Id_{K})$. Способы композиции естественных преобразований были [представлены в обзоре ранее](https://habr.com/ru/articles/951574/).

Такой универсальный функтор $\mathrm{Ran_F\, K} \equiv K/F$ вместе с естественным преобразованием $\varepsilon$ называется **правым расширением Кана функтора $K$ вдоль $F$**.

Да уж, название то ещё… У математиков вообще очень странное воображение. Но давайте всё же попробуем их понять ~~и простить~~.
### !! что расширяем-то?

### !! расширение как сопряжение
