...
В категории $\mathrm{Set}$ между любыми объектами полно морфизмов, которых нет в $\mathrm{Mon}$. Основная идея заключается в том *забывающий функтор* $U$ **забывает ограничения** $\mathrm{Mon}$. А за восстановление потерянного отвечает функтор $M$, сопряжённый к $U$ слева: $M \vdash U$.
