...
Представление ко-Йонеды позволяет отделить описание бизнес логики (цепочки контейнерных преобразований) от её интерпретации (`lowerCoyo`). 
требуется лишь в самом конце, в момент интерпретации `lowerCoyo`.  
