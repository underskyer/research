...
«тяжёлых» функторов рекурсивных структур данных (деревья, списки). Как сделать автоматическое срабатывание такой оптимизации?

Для этого потребуется новый функтор $よ_F \cong F$
