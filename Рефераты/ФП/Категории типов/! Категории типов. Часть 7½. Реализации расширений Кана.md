...
Замечательной особенностью представлений Йонеды является то, онони изоморфно исходному функтору:
$$
\begin{split}
Fa 
\\
...
Действительно, ветви изоморфизма образуют единица расширения вместе с универсальным морфизмом кандидата $(H, \alpha)=(F, id_F)$:
```scala
...
Для представления ко-Йонеды имеем дуальную ситуацию:
```scala
