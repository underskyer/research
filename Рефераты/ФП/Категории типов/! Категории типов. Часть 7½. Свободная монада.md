...
$$где $\tilde F = Id/U \dashv U$ — *свободный* функтор для *забывающего* $U$ некоторой промежуточной категории. И, пожалуй, самой важной для нашего случая будет категория монад $\mathrm{Mon}(\mathcal{C})$ с забывающим функтором $U_M: \mathrm{Mon}(\mathcal{C}) \to \mathrm{Endo}(\mathcal{C})$ в категорию эндофункторов $\mathrm{Endo}(\mathcal{C})=\mathcal{C}^\mathcal{C}$.

$$
\begin{split}
\mathrm{Free}&: \mathrm{Endo}\big(\mathcal{C}\big) \to \mathrm{Endo}(\mathcal{C})
= U_M / U_M,
\\
U_M&: \mathrm{Mon}(\mathcal{C}) \to \mathrm{Endo}\big(\mathcal{C}),
\\
\mathrm{Free}\, F\, a &= \int_{M:\,\mathrm{Mon}(\mathcal{C})}
\big(F \rightsquigarrow U(M)\big) \to U(M) a.
\end{split}
$$
По сути это ни что иное, как воплощение универсального свойства свободной монады. Такой конец даст нам одну из самых простых реализаций.

Родство функторов $F$ и $T$ легче заметить, переписав универсальное свойство через изоморфизм естественных преобразований: $\mathrm{Hom}\, (F, M) \cong \mathrm{Hom}\, (T, M)$. Но более важно, что из этого изоморфизма, справедливого для любого $M$, следует изоморфизм категорий *алгебр функтора* и *алгебр монады*:
$$
...
Другим важным сопряжением, порождающим монаду, является сопряжение Эйленберга-Мура, проходящую как раз через категорию $\mathcal{Alg}_T$. Значит, пользуясь изоморфизмом категорий алгебр, мы можем выразить искомый функтор $T$ через забывающий функтор $U_F\colon \mathcal{Alg}_F \to \mathcal{C}$ из известной категории F-алгебр: $T = \mathrm{Codens}\,U_F$.
...
\end{split}
$$
Эти равенства дадут ещё две программные реализации свободной монады.
