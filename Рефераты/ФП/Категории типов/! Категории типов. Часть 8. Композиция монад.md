...
- в также различные комбинации перечисленного выше.

Эффекты обнаруживаются лишь в момент «распаковки» соответствующего контейнера. При применении к нему различных преобразований контейнер может модифицировать свой «контекст распаковки». Конечно же, должны существовать и способы первоначального создания контекста эффекта.
