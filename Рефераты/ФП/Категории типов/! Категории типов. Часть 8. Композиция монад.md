...
Конечно же, должны существовать и способы первоначального создания контекста эффекта, экземпляра контейнера. Современные ФП-программы строятся как цепочки, составленные из подобных функций.
