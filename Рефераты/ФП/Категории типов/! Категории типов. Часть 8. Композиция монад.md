...
Итак, не всякий функтор может стать монадой даже теоретически. Даже если у нас есть пара монад $F$  $G$, то композитный функтор $F \circ G$ не обязан быть монадой. [Ранее](https://habr.com/ru/articles/957848/#distributive) уже говорилось, для сборки такой композитной монады необходим *дистрибутивный закон* — преобразование $\lambda \colon G \circ F \rightsquigarrow F \circ G$.
