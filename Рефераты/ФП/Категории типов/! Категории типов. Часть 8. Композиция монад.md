...
Функторы в программировании ассоциируются с «эффектами», которые обнаруживаются в момент «распаковки» соответствующего контейнера. Контейнер хранит «контекст распаковки» и может изменять его при применении к нему различных преобразований.
