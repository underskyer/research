...
Рассмотрим дистрибутивный закон $\lambda^G(F)\colon F \circ G \rightsquigarrow G \circ F$ для *фиксированного* функтора $G$ и произвольного $F$. Если вместо $F$ подставить экспоненциал $\mathrm{Hom}(a, \_)$ или константный функтор в терминальный объект $\Delta_1$, то можно убедиться, что функтор $G$
