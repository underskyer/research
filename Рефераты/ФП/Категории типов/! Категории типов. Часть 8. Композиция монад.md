...
Рассмотрим дистрибутивный закон $\lambda^G(F)\colon F \circ G \rightsquigarrow G \circ F$ для *фиксированного* функтора $G$ и произвольного $F$. Подставив вместо $F$ различные варианты (экспоненциал, произведение, константный функтор в терминальный объект…) можно убедиться, что функтор $G$ обязан сохранять вообще любые пределы. [Ранее](https://habr.com/ru/articles/970762/#continuty) уже говорилось, что такие функторы называются непрерывными.
